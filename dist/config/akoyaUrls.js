export const DEFAULT_AKOYA_URLS = {
...
export const DEFAULT_AKOYA_GENERAL_CONFIG = {
    provider_id: 'mikomo',
    data_version: 'v3',
...
export const AKOYA_GENERAL_CONFIG_ENV = {
...
export const AKOYA_GENERAL_CONFIG_KEYS = [
    'provider_id',
    'data_version',
    'management_version',
...
export const DEFAULT_AKOYA_CREDENTIALS = {
    client_id: '',
    client_secret: ''
};
export const AKOYA_CREDENTIAL_ENV = {
    client_id: 'AKOYA_CLIENT_ID',
    client_secret: 'AKOYA_CLIENT_SECRET'
};
export const AKOYA_CREDENTIAL_KEYS = ['client_id', 'client_secret'];
export const DEFAULT_AKOYA_TOKENS = {
    id_token: '',
    refresh_token: '',
    service_token: '',
