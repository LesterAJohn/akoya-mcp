...
function isSensitiveOutputAllowed(): boolean {
...
function maskSensitiveTokenFields(payload: unknown): unknown {
...
async function resolveUserIdToken(
...
export function buildServer(): McpServer {
  ...
  server.registerTool(
    ...
    async ({ userId, providerId, idToken, ...input }) =>
      toTextResponse(
        await akoyaService.accountInfo({
          ...input,
          providerId,
  ...
  server.registerTool(
    ...
    async ({ userId, providerId, idToken, ...input }) =>
      toTextResponse(
        await akoyaService.transactions({
          ...input,
          providerId,
          idToken: await resolveUserIdToken(vaultService, userId, providerId, idToken)
        })
  ...
  server.registerTool(
    ...
    async ({ userId, providerId, idToken, ...input }) =>
      toTextResponse(
        await akoyaService.customerInfo({
          ...input,
          providerId,
          idToken: await resolveUserIdToken(vaultService, userId, providerId, idToken)
        })
  ...
  server.registerTool(
    ...
    async ({ userId, providerId, idToken, ...input }) =>
      toTextResponse(
        await akoyaService.accountHolderInfo({
          ...input,
          providerId,
          idToken: await resolveUserIdToken(vaultService, userId, providerId, idToken)
        })
  ...
  server.registerTool(
    ...
    async ({ userId, providerId, idToken, ...input }) =>
      toTextResponse(
        await akoyaService.statementList({
          ...input,
          providerId,
          idToken: await resolveUserIdToken(vaultService, userId, providerId, idToken)
        })
  ...
  server.registerTool(
    ...
    async ({ userId, providerId, idToken, ...input }) =>
      toTextResponse(
        await akoyaService.searchTaxForms({
          ...input,
          providerId,
          idToken: await resolveUserIdToken(vaultService, userId, providerId, idToken)
        })
  ...
  server.registerTool(
    ...
    async ({ userId, providerId, idToken, ...input }) =>
      toTextResponse(
        await akoyaService.retrieveTaxForm({
          ...input,
          providerId,
          idToken: await resolveUserIdToken(vaultService, userId, providerId, idToken)
        })
